...
QT_MOC_LITERAL(1, 13, 11), // "cellUpdated"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 3), // "row"
QT_MOC_LITERAL(4, 30, 3), // "col"
QT_MOC_LITERAL(5, 34, 5), // "value"
QT_MOC_LITERAL(6, 40, 15), // "solvingFinished"
QT_MOC_LITERAL(7, 56, 6), // "solved"
QT_MOC_LITERAL(8, 63, 6), // "timeMs"
QT_MOC_LITERAL(9, 70, 11) // "performStep"

    },
    "SudokuSolver\0cellUpdated\0\0row\0col\0"
    "value\0solvingFinished\0solved\0timeMs\0"
    "performStep"
};
...
void SudokuSolver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->cellUpdated((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->solvingFinished((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->performStep(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SudokuSolver::*)(int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SudokuSolver::cellUpdated)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SudokuSolver::solvingFinished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SudokuSolver::cellUpdated(int _t1, int _t2, int _t3)
{
...
// SIGNAL 1
void SudokuSolver::solvingFinished(bool _t1, int _t2)
{
